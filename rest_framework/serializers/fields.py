...
# from rest_framework.utils.transcoder import encoding
...
__all__ = [
    'empty', 'Field', 'BooleanField', 'NullBooleanField', 'CharField',
     'UUIDField',
    'IntegerField', 'FloatField', 'DateTimeField', 'DateField', 'TimeField',  'ChoiceField',
    'MultipleChoiceField',  '_UnvalidatedField', 'ListField', 'JSONField',
]
...
#             return None
#         value = encoding.force_text(value).strip()
#         try:
#             value = Decimal(value)
