...
from rest_framework.helpers.crypto import get_random_string, pbkdf2, constant_time_compare
from rest_framework.helpers.encoding import force_bytes, force_text
from rest_framework.helpers.functional import import_class_attribute
...
def get_hashers():
    ...
    for hasher_path in settings.PASSWORD_HASHERS:
        hasher = import_class_attribute(hasher_path)()
