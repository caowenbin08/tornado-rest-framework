...
NUMERIC_FIELD_TYPES = (peewee.IntegerField, peewee.FloatField, peewee.DecimalField)
...
def get_field_kwargs(field_name, model_field):
    ...
    if max_length is not None and isinstance(model_field, (peewee.CharField, peewee.TextField)):
