...
from rest_framework.core.parsers.response import HttpResponseParser
from enum import Enum
from rest_framework.core.client.connection import Connection
from rest_framework.core.client.exceptions import StreamAlreadyConsumed
from rest_framework.core.client.request import Request
from rest_framework.core.client.decoders import GzipDecoder
from rest_framework.core.client.cookies import CookiesJar, Cookie
...
class Response:
    ...
    def on_message_complete(self):
        ...
        try:
            ...
            logger.error("release connection error", exc_info=True)
