...
from rest_framework.core.responses import update_current_time
from rest_framework.core.protocol import ConnectionStatus, update_current_time as update_time_protocol
