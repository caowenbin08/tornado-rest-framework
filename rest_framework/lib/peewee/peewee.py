...
# mysql
try:
    import pymysql as mysql  # prefer the C module.
except ImportError:
    try:
...
try:
    from rest_framework.lib.peewee.playhouse._speedups import format_date_time
    from rest_framework.lib.peewee.playhouse._speedups import sort_models_topologically
    from rest_framework.lib.peewee.playhouse._speedups import strip_parens
except ImportError:
...
try:
    from rest_framework.lib.peewee.playhouse._speedups import _DictQueryResultWrapper
    from rest_framework.lib.peewee.playhouse._speedups import _ModelQueryResultWrapper
    from rest_framework.lib.peewee.playhouse._speedups import _SortedFieldList
    from rest_framework.lib.peewee.playhouse._speedups import _TuplesQueryResultWrapper
except ImportError:
