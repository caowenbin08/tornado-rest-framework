...
class AioExtQueryResultWrapper(AioQueryResultWrapper, ExtQueryResultWrapper):
    pass


class AioTuplesQueryResultWrapper(AioExtQueryResultWrapper, TuplesQueryResultWrapper):
    pass


class AioNaiveQueryResultWrapper(AioExtQueryResultWrapper, NaiveQueryResultWrapper):
    pass


class AioDictQueryResultWrapper(AioExtQueryResultWrapper, DictQueryResultWrapper):
    pass


class AioModelQueryResultWrapper(AioQueryResultWrapper, ModelQueryResultWrapper):
    pass


class AioAggregateQueryResultWrapper(AioModelQueryResultWrapper, AggregateQueryResultWrapper):
